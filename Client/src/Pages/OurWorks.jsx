...
const OurWorks = () => {
  const brandLogo = [
    ...
    { no: '4', name: 'MG', image: '/images/works/WhatsApp-Image-2024-04-19-at-5.53-1-4.webp' },
    { no: '5', name: 'Fundfloat', image: '/images/works/WhatsApp-Image-2024-04-19-at-5.53-1-7.png' },
    { no: '6', name: 'Akriti', image: '/images/works/Artboard-1-1.webp' },
    { no: '7', name: 'Lagnuvo', image: '/images/works/430050566_1393812864593801_3386726375752106791_n.jpg' },
    { no: '8', name: 'Aroosa', image: '/images/works/Aroosa-1000x-662.webp' },
    { no: '9', name: 'Aroosa', image: '/images/works/DSC00086-1-1.webp' },
    { no: '10', name: 'Muthoot', image: '/images/works/IMG-20240318-WA0134.webp' },
    { no: '11', name: 'Ovolo', image: '/images/works/ovolo-X-QC-02.webp' },
    { no: '12', name: 'Glamata', image: '/images/works/psd-6-scaled.webp' },
    { no: '13', name: 'Gratis', image: '/images/works/QCXgratis-cover.webp' },
    { no: '14', name: 'Impex', image: '/images/works/Vadamvali-100x-662.webp' },
    { no: '14', name: 'Wea Design', image: '/images/works/wea-design-5-1.webp' },
  ];
